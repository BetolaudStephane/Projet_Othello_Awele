...
ev=[1,6,0,0,0]
#ev=[1,30,-15,3,0]
#ev=[1.0, 35.60000000000001, -14.8, 0.40000000000000013, 2.8]


def evaluation(jeu,coup,joueur):
    return ev[0]*score(jeu,joueur)+ev[1]*VCoin(jeu,joueur)+ev[2]*VCoteCoin(jeu,joueur)+ev[3]*Bord(jeu,joueur)
#+ev[4]*Mobilite(jeu,joueur)
